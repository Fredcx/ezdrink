...
export default function AdminTeamPage() {
    ...
    const fetchTeam = async () => {
        setLoading(true);
        try {
            const res = await fetch('http://localhost:3001/api/establishment/team', {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:3001/api/establishment/team/${id}`, {
                method: 'DELETE',
    ...
    const handleCreateMember = async () => {
        ...
        try {
            const res = await fetch('http://localhost:3001/api/establishment/team/generate', {
                method: 'POST',
                headers: {
